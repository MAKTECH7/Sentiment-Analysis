...
def renderApp():
    ...
    # Ayan khan
    resume_file = current_dir / "Assest" / "ayan_resume.pdf"
    ...
    EMAIL = "ayank9974@gmail.com"
    # st.title("Gourav")

    HNAME = "Ayush Nagar"
    HDES = "FrontEnd Developer"
    HEMAIL = "ayushnagar@acropolis.in"

    INAME = "Kuldeep parmar"
    IDES = "Designer"
    IEMAIL = "Kuldeep@acropolis.in"

    JNAME = "Kuldeep singh jadon"
    JDES = "Researcher"
    JEMAIL = "Kuldeepsingh@acropolis.in "
